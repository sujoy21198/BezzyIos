...
class SignUpScreen extends React.Component {
  ...
  signUp = async () => {
    ...
    let response = await axios.post(
      DataAccess.BaseUrl + DataAccess.Registration,
      formData,
    ...
    if (response.data.resp === "true") {
      ...
      this.props.navigation.navigate("OtpVerify", {
        userId: response.data.log_userID,
        type: "verify",
      });
          ...
          >
            <Item
              style={{
                alignItems: "center",
                borderBottomWidth: 1,
                borderBottomColor: this.state.isNameFocused
                  ? "#69abff"
                  : "#a9a9a9",
                marginTop: heightToDp("2%"),
...
export default (props) => {
  ...
  return <SignUpScreen {...props} insets={insets} />;
};
