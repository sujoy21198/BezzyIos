...
class CommentScreen extends React.Component {
  constructor(props) {
    ...
    this.state.post_id =
      typeof this.props.route.post === "object"
        ? this.props.route.post.post_id
        : this.props.route.params.post.post_id;
  }
  ...
  getPostCommentedUsers = async () => {
    ...
    let response = await axios.post(
      DataAccess.BaseUrl + DataAccess.postCommentedUsers,
      {
    ...
    if (response.data.status === "success") {
      ...
      comments.map((i) => {
        if (response.data.activity.rescommentID == i.comment_id) {
          i.login_user_like_comment =
            i.login_user_like_comment == "Yes" ? "No" : "Yes";
...
export default (props) => {
  ...
  return <CommentScreen {...props} insets={insets} />;
};
