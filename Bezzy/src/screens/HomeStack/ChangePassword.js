...
class ChangePassword extends React.Component {
  ...
  changePassword = async () => {
    ...
    let response = await axios.post(
      DataAccess.BaseUrl + DataAccess.changePassword,
      {
        userID: userId,
        ...
        >
          <View
            style={{
              ...
              alignItems: "center",
              borderBottomWidth: 1,
              borderBottomColor: this.state.isCurrentPasswordFocused
                ? "#69abff"
                : "#a9a9a9",
          ...
          >
            ...
            >
              <Label
                style={{
                  color: this.state.isCurrentPasswordFocused
                    ? "#69abff"
                    : "#808080",
                  fontSize: widthToDp(
                    `${this.state.isCurrentPasswordFocused ? 3 : 3.4}%`
                  ),
              ...
              <Input
                ...
                onChangeText={(text) =>
                  this.setState({ currentPassword: text.trim() })
                }
                onFocus={() =>
                  this.setState({
...
export default (props) => {
  ...
  return <ChangePassword {...props} insets={insets} />;
};
