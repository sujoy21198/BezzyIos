...
class ImagePreviewScreen extends React.Component {
  ...
  getPostDetails = async () => {
    ...
    let response = await axios.get(
      DataAccess.BaseUrl +
        DataAccess.getPostDetails +
        "/" +
        this.props.route.params.image.post_id +
        "/" +
        userId,
    ...
    if (response.data.status === "success") {
      ...
      response.data.post_details.post_img_video_live &&
        response.data.post_details.post_img_video_live.length > 0 &&
        response.data.post_details.post_img_video_live.map(
      ...
      },
      {
        ...
        onPress: async () => {
          ...
          let response = await axios.post(
            DataAccess.BaseUrl + DataAccess.deletePost,
            {
  ...
  updateCaption = async () => {
    if (!this.state.captionEditable) {
      ...
      let response = await axios.post(
        DataAccess.BaseUrl + DataAccess.updatePostCaption,
        {
  ...
  render = () =>
    Platform.OS === "android" ? (
      <ScrollView style={{ flex: 1, backgroundColor: "#1b1b1b" }}>
        ...
        <LinearGradient
          style={{
            paddingTop: heightToDp(
              `${
                this.state.postUrl.length !== 0
                  ...
                  <View
                    style={{
                      height:
                        ...
                        this.props.route.params.hideFunctionalities
                          ? heightToDp("100%")
                          : heightToDp("80%"),
                    }}
                  >
          ...
          >
            {this.state.captionEditable ? (
              <TextInput
                style={{
                  ...
                  width: widthToDp(
                    this.props.route.params.type === "otherUserPost" ||
                      this.props.route.params.noEditCaption
                      ? "88%"
                      : "83%"
                  ),
                  borderBottomWidth:
                ...
                onChangeText={(text) =>
                  this.setState({ postCaption: text.trim() })
                }
              />
            ) : (
              <Autolink
                ...
                >
                  {this.state.otherProfile === false ? (
                    this.state.isUpdatingCaption ? (
                      ...
                      <Icon
                        name={
                          this.state.captionEditable ? "paper-plane" : "pen"
                        }
                        color="#fff"
        ...
        {!(
          ...
          >
            ...
            <TouchableOpacity
              onPress={() => {
                if (this.player) this.player = undefined;
                this.props.navigation.navigate("PostLikedUsersList", {
                  postId: this.props.route.params.image.post_id,
                });
              }}
            >
              <Text
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                ...
                this.props.navigation.navigate("CommentScreen", {
                  post: this.props.route.params.image,
                });
              }}
              disabled={
            ...
            >
              {this.props.route.params.commentCount
                ? this.props.route.params.commentCount
...
export default (props) => {
  ...
  return <ImagePreviewScreen {...props} insets={insets} />;
};
