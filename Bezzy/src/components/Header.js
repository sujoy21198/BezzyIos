      ...
      Alert.alert("Log out", "Are you sure to Log out?", [
        ...
        },
        {
          ...
          onPress: async () => {
            ...
            await axios
              .post(
                DataAccess.BaseUrl + DataAccess.setUserActiveStatus,
                {
                  userID: userID,
  ...
  getNotificationCount = async () => {
    ...
    if (response.data.status === "success") {
      ...
      response.data.notification_list.map((item) => {
        item.is_view !== "1" && notifications.push(item);
      });
    ...
    <SafeAreaView
      style={{
        ...
        backgroundColor:
          ...
          this.props.isHomeStackInnerPage
            ? "#fff"
            : "#69abff",
        ...
        >
              ...
              {!this.props.headerText ? (
                <Image
                  ...
                  style={{
                    height: heightToDp("3%"),
                    width: widthToDp("20%"),
                    marginLeft: widthToDp(
                      `${
                        this.props.isBackButton ? 3 : Platform.isPad ? -3 : 0
                      }%`
                    ),
                  }}
                />
          ...
          >
            {(this.props.isHomeScreen ||
              this.props.isMessageScreen ||
              this.props.isProfileFocused ||
              (this.props.isHomeStackInnerPage && !this.props.settings)) && (
              <>
                <TouchableOpacity
                ...
                {this.props.isHomeScreen && (
                  <Icon1
                    ...
                    style={{
                      marginHorizontal: 10,
                      marginLeft:
                        this.state.notificationCount > 0 ? undefined : 10,
                      marginRight:
                        this.state.notificationCount > 0 ? undefined : 0,
                    }}
                    onPress={() =>
                  ...
                  >
                    ...
                    >
                      {this.state.notificationCount > 99
                        ? String(this.state.notificationCount) + "+"
              ...
              <>
                ...
                >
                  <TouchableOpacity
                    onPress={() => {
                      this.props.resetPage && this.props.resetPage();
                      this.navigateToOtherScreen("block");
                    }}
                  >
                    <Text
                      style={{
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      this.props.resetPage && this.props.resetPage();
                      this.navigateToOtherScreen("changePassword");
                    }}
                  >
                    <Text
                      style={{
                  ...
                  <TouchableOpacity
                    onPress={() => {
                      this.props.resetPage && this.props.resetPage();
                      this.navigateToOtherScreen("logout")
                    }}
                  >
                    <Text
                      style={{
            ...
            this.props.block
              ...
              ? this.props.navigation.reset({
                  ...
                  routes: [
                    {
                      name: "CommentScreen",
                      post: { post_id: this.props.post.post_id },
                    },
                  ],
                })
